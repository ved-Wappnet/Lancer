...
const ClientContractsPage = () => {
  ...
  // Fetch contracts for client from API
  const { data, isLoading, isError } = useGetContractsQuery({ role: 'client', userId: user?.id });
            ...
            <table className="min-w-full text-sm border">
              ...
              <tbody>
                {contracts.map((contract: any) => {
                  ...
                  return <tr key={contract.id} className="border-b last:border-0">
